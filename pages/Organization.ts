...
export class organizationPage {
    ...
    organaizationheader:Locator;
    createorgbut:Locator;
    creatorgheader:Locator;
    orgName:Locator;
    industry:Locator;
    accountType:Locator;
    savebutton:Locator;
    ...
    async createOrganization(orgNames:string, inds:string, acctypes:string) {
    ...
    async verifyOrganizationCreation(organizationName:string) {
