...
export class productsPage {
    ...
    async createproductdetail(productname:string, unitPrice:string, usageunit:string, qtyinstock:string, path:string, uploadpath:string, filepath:string) {
