...
export class opportunitiesPage {
    page: Page
    opportunitiesModule: Locator;
    createOpportunitiesButton: Locator;
    opportunityName: Locator;
    Organizations: Locator;
    Campaign: Locator;
    saveButton: Locator;
    opportunityNameText: Locator;
    creatingNewOpportunityText: Locator;
    company: string;
    contact: string;
    opportunityheader: Locator;
    ...
    async createOpportunities(OpportunityName: string) {
    ...
    async verifyOppurtunity(OpportunityName: string) {
